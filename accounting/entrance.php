<?php
		...
		include'functions/addentrance.php';
	...
	<div id="wrapper">
		...
		<div class="main">
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Entrance Exam Fee Form</h3>
						<div style=" width: 300px;">
                                                    <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#modalForm">NOtify Entrance Exam</button>
                                                <div class="modal fade" id="modalForm" tabindex="-1" role="dialog" aria-labelledby="modalForm">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                <h4 class="modal-title">New message</h4></div>
                                                            <div class="modal-body">
                                                                <form>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="message-texta" class="control-label">Message:</label>
                                    ...
                                    <div class="form-group">
                                          <div class="row gutter">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control" name="idnumber" placeholder="not neccesarily">
                                            </div>
                                        ...
                                        <div class="form-group">
                                        	<div class="row gutter">
                                            	<div class="col-md-4">
		                                                ...
		                                                <input type="number" class="form-control" name="entrance">
                                            	</div>

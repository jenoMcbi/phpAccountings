...
<body>
	...
	<div id="wrapper">
		...
		<!-- END NAVBAR -->
		<!-- LEFT SIDEBAR -->
		<div id="sidebar-nav" class="sidebar print">
		...
		<div class="main">
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Assesment Slip</h3>
					<div class="panel panel-headline">
						<div class="panel-body">
                                              ...
                                              <form method="post"
                                                                ...
                                                                <input type="text" class="form-control print" name="student_id">
                                                                
                                                                <input type="hidden" class="form-control" name="ornumber">
                                                                ...
                                                                <input type="hidden" class="form-control" name="tuition">
                                                                 ...
                                                                 <input type="hidden" class="form-control" name="misyear">
                                                                 <input type="hidden" class="form-control" name="labyear">
                                                                

                                                                
                                                                <button type="submit" name="get" class="btn btn-info btn-lg print" > <span class="fa fa-search"></span></button>

                                                                </form>

                                <!-- <div style="float: right; margin-right: -600px; ">ASSESSMENT SLIP FOR PRELIM</div>CORDOVA PUBLIC COLLEGE<br>ACCOUNTING OFFICE</h4></div></div> -->

                          
                           
                        <?php
                             include'include/vv.php';

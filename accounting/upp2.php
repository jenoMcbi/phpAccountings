...
$query = "UPDATE payments set ornumber='$ornumber', student_id='$student_id',credit_lec='$credit_lec',credit_lab='$credit_lab',total_credit='$total_credit',balance='$balance',misyear='$misyear',labyear='$labyear',typeofpayment='$typeofpayment',tuition='$tuition',misc='$misc',labfee='$labfee',schoolpub='$schoolpub',is_scholarship='$is_scholarship',ssc='$ssc',review='$review' where id='$id'";
                                    ...
                                    <div class="form-group">
                                          <div class="row gutter">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" class="form-control" name="misyear" value="<?php echo $row["misyear"];?>">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="control-label">LAB THIS YEAR</label>
                                                <input type="number" class="form-control" name="labyear" value="<?php echo $row["labyear"];?>">
                                            </div>
                                        ...
                                        <br>
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" class="form-control" name="tuition" value="<?php echo $row["tuition"];?>">
                                            </div>
                                                <div class="col-md-4">
                                                        <label class="control-label">MISC</label>
                                                        <input type="number" class="form-control" name="misc" value="<?php echo $row["misc"];?>">
                                                </div>

                                                <div class="col-md-4">
                                                <label class="control-label">LABORATORY</label>
                                                <input type="number" class="form-control" name="labfee" value="<?php echo $row["labfee"];?>">
                                                </div>
                                                <div class="col-md-4">
                                                <label class="control-label">SCHOOL PUB</label>
                                                <input type="number" class="form-control" name="schoolpub" value="<?php echo $row["schoolpub"];?>">
                                                </div>
                                                <div class="col-md-4">
                                                <label class="control-label">SSC</label>
                                                <input type="number" class="form-control" name="ssc" value="<?php echo $row["ssc"];?>">
                                                </div>
                                            </div>

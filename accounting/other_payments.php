                                        ...
                                        <div class="row gutter">
                                        	 ...
                                        	 <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="advicing_code"
                                                 >
                                                 <button type="submit" name="get2"  class="btn btn-primary">GENERATE!</button>
                                        	</div>

                                            <div class="col-md-4">
                                                <label class="control-label">CREDIT LEC</label>
                                                <input type="number" class="form-control" name="credit_lec" >
                                            </div>
                                            <div class="col-md-4">
                                                <label class="control-label">CREDIT LAB</label>
                                                <input type="number" class="form-control" name="credit_lab" >
                                            </div>
                                            <div class="col-md-4">

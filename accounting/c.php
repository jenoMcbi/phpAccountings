                 ...
                 if(isset($_POST['get']))
                  {
                   $student_id= $_POST['student_id'];
                    ...
                    $query=("SELECT 
									...
									where students_master_file.student_id='$student_id' ORDER BY id DESC");
                                    ...
                                    <div class="form-group">
                                        <div class="row gutter">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="mi" value="<?php echo $row["mname"];?>">
                                            </div>

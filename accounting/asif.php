<?php
		include'functions/addstudent2.php';
                                    ...
                                    <div class="form-group">
                                        <div class="row gutter">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="lastaname" required/>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <label class="control-label">CREDIT_LEC</label>
                                                <input type="text" class="form-control" name="credit_lec" required/>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="control-label">CREDIT_LAB</label>
                                                <input type="text" class="form-control" name="credit_lab" required/>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="control-label">TOTAL_CREDIT</label>
                                                <input type="text" class="form-control" name="total_credit" required/>
                                            </div>
                                            <!-- <div class="col-md-4">
...
<!--                                                  <div id="ifYes1" style="display: none;">  
                                    ...
                                    <div class="col-md-12">
                                                <label class="control-label">SUbJECT DESCRIPTiON</label>
                                        			<textarea class="form-control" name="subject_des" rows="5" required/></textarea>
                                    </div>

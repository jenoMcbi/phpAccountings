...
$sql="SELECT 
		...
		JOIN department d ON d.department_id=d.department_id where typeofpayment='periodic'";
...
?>
			<td colspan="2"><a href="upp3.php?id=<?php echo $row["id"]; ?>"><button type="submit" name="save" class="btn btn-success">modify</button></a>

...
<body>
	...
	<div id="wrapper">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">DATE AND TIME</p>
						</div>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><?php include'include/totalsales.php';?></span>
											<span class="title">TOTAL ENROLLMENT SALES</span>
										</p>
									</div>
								</div>
								<!-- <div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">TOTAL UNPAID/BALACES</span>
										</p>
									</div>
								</div> -->
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><?php include'include/totalothersales.php';?></span>
											<span class="title">OTHERS SALES</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><?php include'include/totalentrancesales.php'; ?></span>
											<span class="title">ENTRANCE EXAM SALES</span>
										</p>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-3">
									<div class="weekly-summary text-right">
										<span class="number"><?php?></span> <span class="percentage"><i class="fa fa-caret-up text-success"></i> 12%</span>
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2017 cpc accounting system by: team accounting</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->

...
$result=sqlsrv_query($conn,$query);
 ...
 {    
    ...
    $query = "UPDATE enrollment set ornumber='$ornumber',idnumber='$idnumber',firstname='$firstname',lastname='$lastname',mi='$mi',typeofpayment='$typeofpayment',entrance='$entrance',review='$review' where id='$id' ";
$result = sqlsrv_query($conn, $query);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="entrance" value="<?php echo $row["entrance"];?>">
                                            </div>

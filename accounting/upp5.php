...
$query=("SELECT * from other_payments where student_id='$student_id'");
...
$result=sqlsrv_query($conn,$query);
 ...
 {    
    ...
    $query = "UPDATE other_payments set ornumber='$ornumber',student_id='$student_id',paymenttype='$paymenttype',amount='$amount',review='$review' where id='$id' ";
$result = sqlsrv_query($conn, $query);
...
<?php 
  ...
  $query = "SELECT * from other_payments where id = '$id'";
  $result = sqlsrv_query($conn,$query);
                                    ...
                                    <div class="form-group">
                                          <div class="row gutter">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="paymenttype" value="<?php echo $row["paymenttype"];?>">
                                            </div>
